      ...
      <fieldset class="ui-grid-b">
        ...
        <div class="ui-block-b">
          <a href="${Root.path}/doc/${doc.id}?mode=edit"
             data-role="button">${Context.getMessage('label.action.Edit')}</a>
        </div>
        <div class="ui-block-c">
          <a href="${Root.path}/doc/${doc.id}?mode=delete-confirmation" data-rel="dialog"
             data-role="button">${Context.getMessage('label.action.Delete')}</a>
        </div>
      </fieldset>
    </div>
    <!-- content -->
